...
function Modaal({keyl}){
    ...
    return(
        <>
        <>
                <div>Prisoner: {keyy[0][0]}</div>
                
                <button className="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" onClick={()=>document.getElementById(`mod-${keyy[0][0]}`).showModal()}>Show path taken by Prisoner {keyy[0][0]}</button>
                ...
                <div className="modal-box">
                    ...
                    <div class="max-h-full w-full max-w-xl overflow-y-auto sm:rounded-2xl bg-white">
                        ...
                        <div class="m-8 my-20 max-w-[400px] mx-auto">
                            ...
                            <div class="space-y-4">
                            <button className="p-3 bg-black rounded-full text-white w-full font-semibold">Close</button>
                            </div>
                        </div>
                        </div>
                    </div>
